...
def drawing(frame_queue, detections_queue, fps_queue):
    ...
    rinkHeight, rinkWidth, channels = img.shape
    capHeight = int(rinkWidth*(9/16))
    ...
    while cap.isOpened():
        ...
        img = rink_image_drawer.rink_drawer(detections,imgNum, out) #Custom Line of Code
